...
export const metadata: Metadata = {
  ...
  description: "Find, review and safely move exact duplicate files and mirrored folders to trash. Original files stay in Drive; small previews are forwarded privately without storage.",
  alternates: {
