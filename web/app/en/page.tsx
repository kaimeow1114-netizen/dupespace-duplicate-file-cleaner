...
export default function EnglishHome() {
  return (
    <main lang="en">
      ...
      <section className="section shell"><div className="section-heading"><span className="eyebrow"><ShieldCheck size={15} aria-hidden="true" /> SAFE BY DESIGN</span><h2>Exact matches are candidates, not automatic deletion decisions.</h2><p>DUPESPACE preserves one keeper, excludes software projects and unverifiable items, revalidates every operation, and never falls back from trash to permanent deletion.</p></div></section>
      <SiteFooter />
    </main>
  );
}
