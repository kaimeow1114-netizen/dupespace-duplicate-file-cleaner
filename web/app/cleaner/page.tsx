...
export default function CleanerPage() {
  ...
  return <main className="cleaner-page"><script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(breadcrumb) }} /><SiteHeader /><section className="cleaner-hero"><div className="shell"><span className="eyebrow light"><ShieldCheck size={16} aria-hidden="true" /> GOOGLE DRIVE + WINDOWS</span><h1><span className="heading-phrase">重複檔案，</span><wbr /><span className="heading-phrase">清楚分組、安心處理。</span></h1><p>DUPESPACE 同時支援 Google Drive 與 Windows 本機資料夾。線上版免安裝，依影片、圖片、PDF 與重要文件排序；Windows 版則在電腦本機完成雜湊比對，提供保留區、清理區與資源回收筒保護。</p></div></section><section className="cleaner-wrap"><nav className="cleaner-source-switch" aria-label="選擇清理位置"><a className="active" href="/cleaner" aria-current="page"><span className="source-icon"><Cloud size={22} aria-hidden="true" /></span><span><b>Google Drive 線上清理</b><small>免安裝，透過 Google Drive 垃圾桶保留復原機會</small></span><em>目前使用</em></a><a href="/download"><span className="source-icon"><HardDrive size={22} aria-hidden="true" /></span><span><b>Windows 本機資料夾</b><small>桌面版提供保留區／清理區與 Windows 資源回收筒</small></span><ArrowRight size={20} aria-hidden="true" /></a></nav><p className="local-cleanup-note"><ShieldCheck size={17} aria-hidden="true" /><span>為了讓本機清理維持可復原，DUPESPACE 不在瀏覽器中永久移除 Windows 檔案；請使用免費桌面版完成本機清理。</span></p><CleanerClient /></section><SiteFooter /></main>;
}
