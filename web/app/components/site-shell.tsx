  ...
  return (
    <header className="site-header">
      <div className="shell nav">
        <a className="brand" href="/"><Image src="/dupesweep-icon.png" alt="" width={38} height={38} /><span>Dupe<em>Sweep</em></span></a>
        <nav aria-label="主要導覽">
  ...
  return (
    <footer className="footer">
      <div className="shell footer-grid">
        <div><a className="brand inverse" href="/"><Image src="/dupesweep-icon.png" alt="" width={38} height={38} /><span>Dupe<em>Sweep</em></span></a><p>安全清理重複檔案，把空間還給重要的事。</p></div>
