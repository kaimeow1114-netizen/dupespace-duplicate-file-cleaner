  ...
  return (
    <footer className="footer">
      <div className="shell footer-grid">
        <div><a className="brand inverse" href="/" aria-label="DUPESPACE"><Image src="/dupespace-icon.png" alt="" width={38} height={38} /><span className="brand-name notranslate" translate="no" lang="en">DUPE<em>SPACE</em></span></a><p>安全清理重複檔案，把空間還給重要的事。</p></div>
