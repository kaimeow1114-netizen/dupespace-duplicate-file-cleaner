  ...
  return (
    <main>
      ...
      <section className="section shell" id="features">
        <div className="section-heading"><span className="eyebrow"><i /> Designed to make accidental deletion difficult</span><h2><span className="heading-phrase">設計目標，</span><wbr /><span className="heading-phrase">就是讓誤刪</span><wbr /><span className="heading-phrase">變得困難。</span></h2><p>內容相同只代表「重複候選」。DUPESPACE 會把用途、位置與檔案變更納入保護流程。</p></div>
