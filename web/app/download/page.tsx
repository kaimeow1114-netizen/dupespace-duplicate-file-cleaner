  ...
  return (
    <main>
      ...
      <section className="shell download-guide">
        ...
        <div className="download-requirements"><div><h2>安裝與使用</h2><ul><li>支援 Windows 10 與 Windows 11。</li><li>不需另行安裝 Python。</li><li>安裝程式可選擇建立桌面捷徑。</li><li>大量結果採漸進顯示，操作完成可下載 CSV 稽核報告。</li></ul></div><div><h2>第一次掃描建議</h2><ol><li>先用少量、可復原的測試副本熟悉流程。</li><li>確認保留區與清理區沒有重疊或巢狀。</li><li>查看完整路徑與保護原因，再移至資源回收筒。</li></ol></div></div>
      </section>
      <SiteFooter />
    </main>
  );
