    ...
    <main>
      ...
      <section className="download-hero">
        <div className="shell download-hero-grid">
          <div>
            ...
            <p>DUPESPACE 只遞迴掃描您加入的本機資料夾，以完整內容比對找出精確重複檔。保護規則優先，再依建立時間與路徑選出建議保留檔；程式碼專案與系統位置不會成為刪除候選。</p>
      ...
      <section className="shell download-guide">
        ...
        <div className="download-safety-grid">
          <article><b>01</b><h3>保護規則永遠優先</h3><p>不必先建立保留區。受保護子資料夾的檔案與外層獨立用途副本都不會自動刪除；其他群組再依建立時間與路徑提出保留建議。</p></article>
          <article><b>02</b><h3>程式碼專案硬性排除</h3><p>Git、SVN、常見建置專案、套件與虛擬環境中的相同設定或依賴，在偵測到對應情境時排除。請另外保護自訂工作資料夾。</p></article>
