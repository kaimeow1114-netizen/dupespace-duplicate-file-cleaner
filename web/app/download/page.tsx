    ...
    <main>
      ...
      <section className="download-hero">
        <div className="shell download-hero-grid">
          <div>
            ...
            <p>選擇想整理的資料夾，DUPESPACE 就會找出內容完全相同的檔案，並建議保留其中一份。程式碼專案、系統位置和受保護資料夾不會自動列入清理。</p>
      ...
      <section className="shell download-guide">
        ...
        <div className="download-safety-grid">
          <article><b>01</b><h3>你保護的資料夾，絕不會自動清理</h3><p>不必先建立保留區。受保護子資料夾的檔案與外層獨立用途副本都不會自動刪除；其他群組再依建立時間與路徑提出保留建議。</p></article>
          <article><b>02</b><h3>程式專案與套件資料夾會自動避開</h3><p>偵測到 Git、SVN、常見建置專案、套件或虛擬環境時，不會把其中的相同設定和依賴當成一般清理項目。自訂工作資料夾仍建議主動加入保護。</p></article>
          <article><b>03</b><h3>預設可復原，失敗也不會偷偷永久刪除</h3><p>移至資源回收筒失敗時，只會清楚顯示失敗原因。永久刪除是獨立的高風險功能，永遠需要另外確認。</p></article>
        </div>
